...
adapter-authored import preview
  ...
  -> prepared-run consumption and review chain
```
...
Prepared-run composition consumes prior read-view facts. The gate and scope
alignment summaries classify review state for manual pre-run review only; a
ready chain is not execution permission and carries no hardware-safety claim.
