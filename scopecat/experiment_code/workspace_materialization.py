"""Workspace materialization engineering prototype.
...
class WorkspaceMaterializationRequest:
    """Typed local request for one approved workspace materialization operation."""
    ...
    def __init__(
        ...
        *,
        ...
        object.__setattr__(self, "content_root", Path(content_root))
    ...
    def from_dict(
        ...
        *,
        ...
        return cls(source=source, content_root=content_root, workspace_root=workspace_root)
...
class WorkspaceMaterializationResult:
    """Approved workspace materialization summary projection."""
    ...
    @property
    def file_results(self) -> tuple[dict[str, Any], ...]:
        return tuple(copy.deepcopy(item) for item in self._summary["file_results"])

    def to_dict(self) -> dict[str, Any]:
        return copy.deepcopy(self._summary)


def execute_workspace_materialization(
    ...
    versions = _version_by_id(source)
    content_root_resolved = _existing_root(request.content_root, "managed content")
    ...
    return WorkspaceMaterializationResult(summary=summary)
...
def materialize_workspace(
    ...
    *,
    ...
    """Raw-dictionary adapter for approved workspace-materialization fixtures."""
    return execute_workspace_materialization(
