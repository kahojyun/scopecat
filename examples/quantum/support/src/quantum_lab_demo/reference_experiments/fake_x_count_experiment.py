"""Function-based authoring for the fake X-count reference experiment."""
...
@sc.module(id="quantum_lab_demo.reference.fake_x_count.capture")
...
@sc.scratch(
    id="quantum_lab_demo.reference.fake_x_count.scratch",
    kind=FAKE_X_COUNT_EXPERIMENT_ID,
...
def fake_x_count_scratch_experiment(
    *,
    ...
    """Build the reference semantics with caller-selected X counts."""
