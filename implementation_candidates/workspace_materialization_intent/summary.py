"""Structured summary builder for workspace materialization intent.

This module is an experimental production-shaped boundary. It is deliberately
side-effect free: it does not inspect the filesystem, create directories,
write files, overwrite existing files, merge workspaces, inspect Git state,
restore environments, import code, execute code, or define workflow/DAG
contracts.
"""
