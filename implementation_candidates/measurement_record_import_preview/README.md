...
It holds a production-shaped experiment for the first incoming measurement
record import-preview slice:
...
- avoid source-file reads, source observation, storage mutation, importer
  behavior, selected-measurement export package preview, package acceptance,
  checksum contracts, schema inference, recursive relation traversal, GUI
