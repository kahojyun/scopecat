...
[`JC-001` passive evidence-view boundary](../decisions/passive-evidence-view.md)
...
| `role` | Yes | Role normalized to the first slice role vocabulary or `unknown`. |
...
| `evidence_handling` | Yes | First-slice evidence handling value. |
