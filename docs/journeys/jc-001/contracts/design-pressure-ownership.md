...
Provisional; scoped to the accepted passive evidence-view slice.
...
evidence-view fact
  ...
  -> allowed first slice responsibility
  -> explicit non-ownership
```

The provisional owner pressure identifies which design-pressure label carries
first slice vocabulary, validation expectations, and missing-fact wording for
that fact family. Future producer behavior still needs a separate
evidence-backed decision.

## Provisional Owner Pressure

| Fact or contract family | Provisional design pressure | Accepted first slice responsibility | Non-ownership |
| --- | --- | --- | --- |
...
## Provisional For This Slice

The table above is the complete provisional assignment for this slice. A later
