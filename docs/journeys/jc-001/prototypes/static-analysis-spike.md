...
[`../contracts/evidence-view.md`](../contracts/evidence-view.md). It is
...
| --- | --- |
| Artifact roles | Preserved from the manifest and normalized to the first slice vocabulary. |
...
This validates the first slice at spike level:
