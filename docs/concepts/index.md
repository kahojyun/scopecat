...
Concept guides explain the stable mental models needed to author and interpret
Scopecat workflows:
...
- [Glossary](glossary.md) defines the user-facing vocabulary shared by Python,
  the CLI, and the project console.

Daemon internals, lowering, worker boundaries, and scalability belong to
[developer architecture](../development/architecture/index.md).
