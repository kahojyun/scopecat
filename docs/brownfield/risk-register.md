...
| BR-RISK-002 | Legacy parser creep | Migration / Architecture | High | Measurement import, source observation, handoff package preparation. | DEC-003, DEC-004 | [`transition-architecture.md`](transition-architecture.md), [`../decisions/architecture/DEC-003-import-source-anti-corruption-boundary.md`](../decisions/architecture/DEC-003-import-source-anti-corruption-boundary.md) | Use adapters and anti-corruption boundaries; do not parse arbitrary legacy sources in core. |
