...
| BR-RISK-010 | Trust/authenticity overclaim | Product semantics | Medium | Handoff package open, import, source observation, external references. | ADR-0002, ADR-0003 | [`migration-strategy.md`](migration-strategy.md), workflow validation map | Keep review, integrity observation, trust, authenticity, scientific validity, and accepted import separate. |
