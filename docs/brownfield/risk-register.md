...
| BR-RISK-002 | Legacy parser creep | Migration / Architecture | High | Measurement import, source observation, handoff package preparation. | DEC-003, DEC-004 | [`transition-architecture.md`](transition-architecture.md), [`../decisions/DEC-003-import-source-anti-corruption-boundary.md`](../decisions/DEC-003-import-source-anti-corruption-boundary.md) | Use adapters and anti-corruption boundaries; do not parse arbitrary legacy sources in core. |
...
| BR-RISK-007 | Operator workflow mismatch | Product adoption | Medium | Prepare a manual run, calibration continuation, running monitor, reference-based rerun, post-run results review. | DEC-005, DEC-006 | [`current-state-assessment.md`](current-state-assessment.md), discovery problem briefs | Treat current state as sampled evidence; reopen discovery when real operator behavior does not match the modeled journey. |
...
| BR-RISK-010 | Trust/authenticity overclaim | Product semantics | Medium | Handoff package open, import, source observation, external references. | DEC-003, DEC-004 | [`migration-strategy.md`](migration-strategy.md), workflow validation map | Keep review, integrity observation, trust, authenticity, scientific validity, and accepted import separate. |
...
| BR-RISK-012 | External file observation mistaken for backup | Product / Data integrity | Medium | Source observation, external references, shared lab paths, package materialization. | DEC-003 | [`../decisions/DEC-003-import-source-anti-corruption-boundary.md`](../decisions/DEC-003-import-source-anti-corruption-boundary.md) | Treat observed file state as drift evidence only; require an explicit snapshot, managed copy, archive, or backup decision before claiming restore. |
