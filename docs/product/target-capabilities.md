...
| CAP-002 | Handoff Packages | Engineering prototype | Live prototype evidence | Decide whether to validate GUI receiving state, signature/trust implementation beyond DEC-011, archive packaging/extraction, or a future batch/context import contract next. |
