...
| CAP-002 | Handoff Packages | Engineering prototype | Live prototype evidence | Decide whether to harden selected stored Measurement Record export, trust/authenticity, batch receiving, archive format, or linked-context payload import next. |
