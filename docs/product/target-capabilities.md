...
| CAP-002 | Handoff Packages | Engineering prototype | Live prototype evidence | Decide whether to validate selected-record linked-context payload export, selected-record batch export, linked-context payload import, batch durable import, or signature/trust implementation beyond DEC-011 next. |
