...
| CAP-002 | Handoff Packages | Engineering prototype | Live prototype evidence | Decide whether to validate signature/trust implementation beyond DEC-011, archive packaging/extraction, production-readiness hardening, or a future persisted GUI/batch/context contract next. |
