...
| CAP-002 | Handoff Packages | Engineering prototype | Live prototype evidence | Decide whether to validate batch receiving, linked-context payload import, or signature/trust implementation beyond DEC-011 next. |
