...
| CAP-002 | Handoff Packages | Engineering prototype | Live prototype evidence | Decide whether to validate batch durable import, GUI receiving state, signature/trust implementation beyond DEC-011, or a future context-artifact import contract next. |
