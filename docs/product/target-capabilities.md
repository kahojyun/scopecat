...
| CAP-002 | Handoff Packages | Engineering prototype | Live prototype evidence | Decide whether to validate batch receiving, selected-record linked-context payload export, linked-context payload import, or signature/trust implementation beyond DEC-011 next. |
