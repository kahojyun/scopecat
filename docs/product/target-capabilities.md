...
| CAP-002 | Handoff Packages | Engineering prototype | Live prototype evidence | Decide whether to validate archive packaging/extraction, production-readiness hardening, signed package policy beyond DEC-019, or a future persisted GUI/batch/context contract next. |
