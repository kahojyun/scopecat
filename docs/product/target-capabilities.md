...
| CAP-002 | Handoff Packages | Engineering prototype | Live prototype evidence | Decide whether to validate production-readiness hardening, archive packaging/extraction beyond DEC-020, signed package policy beyond DEC-019, or a future persisted GUI/batch/context contract next. |
