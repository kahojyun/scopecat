...
| CAP-004 | Environment Operation | Discovery | Retired prototype evidence | Restart from a named brownfield entrypoint before promoting implementation again; decide whether bounded manager operations, runtime-readiness review, manifest integration, manager expansion, execution hardening, or GUI/runtime monitoring is justified by a workflow. |
