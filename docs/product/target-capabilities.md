...
| CAP-002 | Handoff Packages | Engineering prototype | Live prototype evidence | Decide whether to validate trust/authenticity for the DEC-010 directory package, batch receiving, or linked-context payload import next. |
