...
| CAP-002 | Handoff Packages | Engineering prototype | Live prototype evidence | Decide whether to validate production readiness hardening, archive-backed import beyond DEC-021 and DEC-024, signature verification/trusted-source policy beyond DEC-019 and DEC-022, or a future persisted GUI/batch/context contract next. |
