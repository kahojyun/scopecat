...
| CAP-002 | Handoff Packages | Engineering prototype | Live prototype evidence | Decide whether to validate linked-context payload import, batch durable import, GUI receiving state, or signature/trust implementation beyond DEC-011 next. |
