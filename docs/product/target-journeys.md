...
| JNY-003 | Recover Or Continue Calibration Work | Recover or continue multi-step calibration work using reviewable fit, evidence, action, and continuation state. | Users recover failed fits, retry decisions, and downstream blocking from scattered notebook state. | UC-CAND-005; supported by UC-CAND-006 | CAND-001, CAP-003, CAP-001 context links | Discovery. | Decide whether repeated calibration continuation needs stable review state and action recording beyond one scenario. |
| JNY-004 | Monitor A Running Measurement | Inspect progress, useful partial data, and shape/completeness signals from long-running measurements before the full run finishes. | Users inspect running work through scripts, partial files, or live plotting tools while completeness and primary-data shape are ambiguous. | UC-CAND-004 | CAP-006, CAP-001 | Discovery. | Validate lifecycle, progress, partial-data, and shape/completeness event recording without scan-control authority. |
...
| JNY-008 | Browse And Review Completed Results | Browse, filter, plot, inspect shaped data, and review completed or near-completed results before handoff, comparison, calibration continuation, or rerun preparation. | Users reopen results through folders, notebooks, plots, reports, sidecars, and memory before deciding whether a result shape or readiness state is clear. | UC-CAND-007; supported by UC-CAND-006 | CAP-001, CAP-005, CAP-002 | Candidate journey with related prototype pressure. | Choose the first live records browser, plotter, shaped-data review, readiness-review, or narrow post-run review route. |
...
| UC-CAND-004 | Candidate use case | Lifecycle, progress, partial-data, and shape/completeness event recording for running measurement inspection. | JNY-004 | CAP-001, CAP-006 | Discovery | [`workflow-validation-map.md`](../engineering/workflow-validation-map.md) |
...
| UC-CAND-007 | Candidate use case | Post-run results browsing, plotting, shaped-data review, and readiness review. | JNY-008 | CAP-001, CAP-002, CAP-005 | Discovery | [`workflow-validation-map.md`](../engineering/workflow-validation-map.md) |
