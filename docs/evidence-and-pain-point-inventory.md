...
resolve in the complete system, while the first useful slice should validate
one narrow, independently valuable path and must not require users to adopt the
