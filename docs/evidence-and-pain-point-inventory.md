...
- Cross-system pressure is strongest when the same or similar protocol is used
  to screen multiple samples on several non-identical equipment and computer
  stacks, or when a setup is being brought up, handed off, or compared against a
