...
premature, but the design pressures behind it should remain visible during W2
...
preserves those intents for W2 without accepting the notes' subsystem map,
