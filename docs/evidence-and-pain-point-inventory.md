...
| Handoff and publication | Good evidence for derived artifacts and source identity loss; user-context pressure makes analysis handoff from control computer to personal analysis computer a high-priority adoption case. | Reports, figures, spreadsheets, decks, analysis-ready data packages, and the missing links back to run, context, code, correction, and decision records. | Whether analysis handoff should be a follow-on journey after bundle identity, or part of the first fixture; public/reference sharing may need curated analysis datasets plus provenance summaries rather than complete work-bundle export. |
...
| PN-004 | Strong follow-on W2 candidate. | direct; inferred | Handoff fixture linking analysis-ready data, figures, reports, spreadsheets, and decks back to source runs, context, code, corrections, and decisions. | I cannot take high-value data off the experiment computer for deeper analysis, figure making, or publication without losing links back to source runs, companion artifacts, corrections, and decisions. | EV-002, EV-008, EV-009, EV-013, EV-017, EV-022, EV-028 | Good follow-on if W2 first establishes bundle identity across context, code, and generated artifacts. Prioritize internal full-fidelity analysis handoff before public/reference export. Avoid a full ELN or report generator. |
