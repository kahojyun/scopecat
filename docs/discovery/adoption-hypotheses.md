...
| Manage calibrated parameter state | Mutable parameter files, copied seed states, trusted versus incomplete calibration state, working-point branches, reviewable diffs, bad states, drift queries, and run links. | Can users recover, compare, edit, and commit calibrated parameter states without Scopecat deciding hardware mutation? |
