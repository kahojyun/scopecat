...
| [`parameter-state-history.md`](parameter-state-history.md) | First-class calibrated parameter state, working points, trusted versus incomplete snapshots, reviewable diffs, run links, and write-back boundaries. |
