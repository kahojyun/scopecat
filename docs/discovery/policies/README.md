...
Policies record repeated boundary vocabulary, artifact classification, and
product strategy that more than one route or slice may need. They do not accept
final product architecture, storage schema, or public API behavior unless a
...
| [`managed-experiment-code-posture.md`](managed-experiment-code-posture.md) | Product strategy for Git-like managed experiment-code versions without requiring users to operate Git. |
