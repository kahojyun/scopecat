...
Policies record repeated discovery boundary vocabulary and artifact
classification that more than one route or slice may need. Product strategy
lives under [`../../product/`](../../product/). These policy notes do not
accept final product architecture, storage schema, or public API behavior
unless a narrower decision document says so.
...
| [`managed-experiment-code-posture.md`](managed-experiment-code-posture.md) | Discovery policy note for Git-like managed experiment-code versions without requiring users to operate Git. |
