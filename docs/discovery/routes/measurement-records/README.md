...
| [`scan-data-shape-decision-summary.md`](../../archive/slice-inventory.md) | Stop rule for scan/data-shape expansion and direction toward preview metadata consumers. |
...
| [`selected-run-handoff-spike-summary.md`](../../archive/slice-inventory.md) | Narrow spike summary before preview-ready export consolidation. |
| [`selected-measurement-export-decision-summary.md`](../../archive/slice-inventory.md) | Decision-ready discovery summary for preview-ready selected measurement export. |
| [`preview-ready-selected-measurement-export-plan.md`](../../archive/slice-inventory.md) | Planning boundary for the source/metadata-first export slice. |
| [`preview-ready-selected-measurement-export-implementation-plan.md`](../../archive/slice-inventory.md) | Code-facing plan for the pure selected measurement export summary builder. |
...
| [`storage-transition-export-fixture.md`](../../archive/slice-inventory.md) | Fixture note for managed storage, external references, source identity, and export materialization pressure. |
| [`storage-transition-export-validation-result.md`](../../archive/slice-inventory.md) | Result of the storage-transition fixture and domain review. |

### Export, Import, Storage, And Source Observation

| Document | Use For |
| --- | --- |
| [`preview-ready-selected-measurement-export-validation-result.md`](../../archive/slice-inventory.md) | First implementation-shaped selected measurement export candidate. |
| [`measurement-record-import-preview-validation-result.md`](../../archive/slice-inventory.md) | Side-effect-free incoming-record import preview candidate. |
| [`normalized-primary-table-validation-result.md`](../../archive/slice-inventory.md) | Historical validation evidence for the promoted route-local normalized primary CSV table contract over already-provided bytes. |
| [`adapter-authored-legacy-import-validation-result.md`](../../archive/slice-inventory.md) | Normalized adapter-authored legacy import manifest candidate. |
| [`adapter-output-boundary-validation-result.md`](../../archive/slice-inventory.md) | File-shaped adapter-produced input boundary as transport pressure. |
| [`legacy-import-acceptance-validation-result.md`](../../archive/slice-inventory.md) | Historical approved copy-into-new-record acceptance candidate; active new-record import is owned by durable Measurement Records import. |
| [`reference-only-legacy-import-validation-result.md`](../../archive/slice-inventory.md) | Reference-only acceptance candidate for preserving external source references. |
| [`reference-only-source-observation-validation-result.md`](../../archive/slice-inventory.md) | File-level observation candidate for preserved external source references. |
| [`legacy-run-sidecar-manifest-validation-result.md`](../../archive/slice-inventory.md) | Local review summary candidate for wrapping an externally executed legacy run with declared legacy source locators, optional context links, primary-data refs, supporting evidence refs, and lifecycle events. |
| [`legacy-locator-sufficiency-review-validation-result.md`](../../archive/slice-inventory.md) | Review-only classifier for whether declared legacy locators are sufficient for human navigation without backend lookup, path parsing, file observation, import acceptance, storage mutation, or repair. |
| [`legacy-sidecar-post-run-review-validation-result.md`](../../archive/slice-inventory.md) | Local post-run review projection over prior legacy sidecar and locator-review summaries without fresh observation, import acceptance, storage mutation, reference repair, parameter write-back, or GUI behavior. |
| [`legacy-sidecar-review-gui-state-validation-result.md`](../../archive/slice-inventory.md) | Passive GUI, CLI, or notebook-ready view-state projection over prior sidecar post-run review, exposing cards and action labels without action execution, backend lookup, file observation, import acceptance, storage mutation, repair, parameter write-back, measurement-validity decisions, or run blocking. |
| [`legacy-file-backed-locator-observation-validation-result.md`](../../archive/slice-inventory.md) | Explicit file-level observation for one selected declared `legacy_path` locator under a caller-provided external root/path without backend lookup, parsing, preview verification, import acceptance, storage mutation, reference repair, parameter write-back, measurement-validity decisions, or GUI behavior. |
| [`legacy-locator-observation-review-bundle-validation-result.md`](../../archive/slice-inventory.md) | Local review composition over prior sidecar post-run review and optional prior file-backed locator observations without fresh observation, backend lookup, parsing, preview verification, import acceptance, storage mutation, reference repair, parameter write-back, measurement-validity decisions, or GUI behavior. |
| [`reviewed-legacy-sidecar-append-intent-validation-result.md`](../../archive/slice-inventory.md) | Explicit operator-approved intent to append reviewed legacy sidecar and locator-observation facts later as review/debug evidence without storage mutation, record write, primary-data import, parsing, preview verification, repair, parameter write-back, measurement-validity decisions, or GUI behavior. |
| [`reviewed-legacy-sidecar-evidence-append-receipt-validation-result.md`](../../archive/slice-inventory.md) | Approved write of one review-evidence receipt under an existing measurement record without primary-data import, parsing, preview verification, repair, parameter write-back, measurement-validity decisions, manifest replacement, read-model refresh, or GUI behavior. |
| [`legacy-evidence-receipt-read-view-validation-result.md`](../../archive/slice-inventory.md) | Read-only view over declared legacy review-evidence receipt paths, surfacing receipt identity and findings without storage scan, mutation, primary-data read/import, parsing, preview verification, repair, parameter write-back, measurement-validity decisions, read-model refresh, or GUI behavior. |
| [`legacy-brownfield-adoption-backbone-validation-result.md`](../../archive/slice-inventory.md) | Post-run-first composition over the legacy sidecar review and review-evidence receipt chain, validating identity/readback continuity while keeping during-run lifecycle support as future-compatible declared events rather than runner ownership. |
| [`legacy-calibration-handoff-parameter-state-bridge-validation-result.md`](../../archive/slice-inventory.md) | Explicit review bridge from a legacy sidecar adoption summary to calibration accepted-write handoff and parameter-state intake, preserving measurement/provenance continuity without legacy write-back, parameter-state storage mutation, hardware apply, or payload import. |
| [`new-run-measurement-writer-validation-result.md`](../../archive/slice-inventory.md) | Side-effect-free writer-event summary candidate. |
| [`measurement-storage-writer-validation-result.md`](../../archive/slice-inventory.md) | Approved append-only storage writer candidate for new records. |
| [`existing-record-update-validation-result.md`](../../archive/slice-inventory.md) | Approved existing-record append update candidate. |
| [`measurement-source-observation-validation-result.md`](../../archive/slice-inventory.md) | Read-only observation candidate for normalized primary data under storage. |
| [`derived-artifact-source-links-validation-result.md`](../../archive/slice-inventory.md) | Explicit derived-artifact source-link candidate. |
...
| [`running-measurement-inspection-validation-plan.md`](../../archive/slice-inventory.md) | First fixture-validation boundary for running inspection. |
| [`running-measurement-inspection-validation-result.md`](../../archive/slice-inventory.md) | Running-inspection implementation candidate. |
...
| [`scan-data-shape-validation-result.md`](../../archive/slice-inventory.md) | Checkpoint for declared scan/data-shape fixture pressure. |
...
| Document | Use For |
| --- | --- |
| [`contents-preview-validation-result.md`](../../archive/slice-inventory.md) | Manifest-only orientation before read-only package use. |
| [`opener-validation-result.md`](../../archive/slice-inventory.md) | Read-only open for directory-shaped Scopecat-authored packages. |
| [`read-view-validation-result.md`](../../archive/slice-inventory.md) | Reader-facing object view over the read-only opener. |
| [`sdk-view-model-validation-result.md`](../../archive/slice-inventory.md) | Thin Python-facing SDK view-model candidate. |
| [`sdk-ergonomics-spike-validation-result.md`](../../archive/slice-inventory.md) | Notebook-style fixture pressure over the SDK view model. |
| [`preview-shape-view-validation-result.md`](../../archive/slice-inventory.md) | Declared preview plot/view projection over read-only handoff packages. |
| [`preview-consumption-validation-result.md`](../../archive/slice-inventory.md) | Preview-aware local consumption composition. |
| [`visual-review-validation-result.md`](../../archive/slice-inventory.md) | Plot-first local review view model. |
| [`gui-view-state-validation-result.md`](../../archive/slice-inventory.md) | Local GUI-ready view-state projection. |
| [`visual-artifact-validation-result.md`](../../archive/slice-inventory.md) | Local static HTML review artifact candidate. |
| [`inspection-workflow-validation-result.md`](../../archive/slice-inventory.md) | Receiving-side local inspection workflow. |
| [`route-pressure-validation-result.md`](../../archive/slice-inventory.md) | Richer repository-safe route-pressure fixtures. |
| [`acceptance-validation-result.md`](../../archive/slice-inventory.md) | Approved receiving-side storage acceptance candidate. |
| [`integrity-observation-validation-result.md`](../../archive/slice-inventory.md) | Read-only package-local integrity observation candidate. |
| [`receiving-workflow-validation-result.md`](../../archive/slice-inventory.md) | Receiving-side workflow composition over inspection, integrity observation, and acceptance. |
| [`writer-validation-result.md`](../../archive/slice-inventory.md) | Approved directory-shaped handoff package writer candidate. |
| [`round-trip-validation-result.md`](../../archive/slice-inventory.md) | Writer-to-reader compatibility candidate. |

### Support Candidates

| Document | Use For |
| --- | --- |
| [`contract-primitives-validation-result.md`](../../archive/slice-inventory.md) | Narrow shared validation helpers for repeated low-level checks. |
| [`filesystem-mutation-helpers-validation-result.md`](../../archive/slice-inventory.md) | Narrow no-overwrite filesystem mutation helpers. |
