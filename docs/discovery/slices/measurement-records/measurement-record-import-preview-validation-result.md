...
See
[`measurement-data-reference-boundary.md`](../../policies/measurement-data-reference-boundary.md).
...
[`slices/measurement-records/handoff/contents-preview-validation-result.md`](handoff/contents-preview-validation-result.md).
