...
[`routes/adoption-routes.md`](../../routes/adoption-routes.md). This note only keeps the
...
Result owner:
[`modern-manifest-preflight-validation-result.md`](../environment-operation/modern-manifest-preflight-validation-result.md)
...
Result owner:
[`uv-sync-intent-validation-result.md`](../environment-operation/uv-sync-intent-validation-result.md)
...
Result owner:
[`uv-sync-result-validation-result.md`](../environment-operation/uv-sync-result-validation-result.md)
...
Result owner:
[`environment-operation-review-bundle-validation-result.md`](../environment-operation/environment-operation-review-bundle-validation-result.md)
