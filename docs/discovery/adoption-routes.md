...
| Capture experiment code versions | Selected code context defining a captured code-version candidate. | Copied folders, notebooks, backup trees, entrypoint ambiguity, helper roots, local dependency notes, selected references, last-working code, and cross-computer code drift. | Users identify the code context that mattered for a measurement, calibration step, analysis, or handoff, then capture or restore point-in-time code versions without adopting Git-facing workflow up front. | [`README.md#experiment-code-context`](README.md#experiment-code-context), [`problem-briefs/experiment-code-selection.md`](problem-briefs/experiment-code-selection.md), [`managed-experiment-code-posture.md`](managed-experiment-code-posture.md), [`experiment-code-selection-next-boundary.md`](experiment-code-selection-next-boundary.md). |
