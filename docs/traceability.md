...
| --- | --- | --- | --- | --- | --- |
| Selected measurements are reconstructed from folders, notebooks, reports, sidecars, and memory before handoff. | JNY-001 | Missing UC: export one selected stored Measurement Record to a preview-ready single-measurement handoff package. | CAP-001, CAP-002. | [`engineering/workflow-validation-map.md`](engineering/workflow-validation-map.md) | `scopecat.measurement_records`, `scopecat.handoff` in [`engineering/implementation-register.md`](engineering/implementation-register.md) |
...
| Users need to inspect selected parameter, code, setup, and environment context before a manual run. | JNY-002 | UC-005; scenario evidence for prepared-run context and acknowledgement. | CAP-003, CAP-005, CAP-004, CAP-001 context links. | [`engineering/workflow-validation-map.md`](engineering/workflow-validation-map.md) | `scopecat.parameter_state`, `scopecat.environment_operation` |
| Code context is reconstructed from copied folders, notebooks, helper libraries, backups, and editable working trees. | JNY-005 | Missing UC: choose one concrete step to promote: record, compare, materialize, observe editable folder, prepare rerun, or GUI review. | CAP-005, CAP-004. | [`brownfield/migration-roadmap.md`](brownfield/migration-roadmap.md), discovery experiment-code route. | No live product capability owner yet; related operation evidence in `scopecat.environment_operation`. |
| Long-running measurements expose partial data and progress before full completion. | JNY-004 | Missing UC: validate explicit lifecycle, progress, and partial-data event recording. | CAP-006, CAP-001. | [`brownfield/migration-roadmap.md`](brownfield/migration-roadmap.md), [`engineering/workflow-validation-map.md`](engineering/workflow-validation-map.md) | No live monitor owner yet; related Measurement Records inspection pressure. |
| Calibration continuation depends on notebook state, fit previews, manual decisions, proposed writes, and downstream blocking. | JNY-003 | Missing UC: decide whether repeated calibration continuation use cases require stable capability ownership. | CAND-001, CAP-003, CAP-001 context links. | [`discovery/routes/calibration-continuation/decision.md`](discovery/routes/calibration-continuation/decision.md), [`brownfield/migration-roadmap.md`](brownfield/migration-roadmap.md) | No live calibration route owner yet; parameter-state bridge evidence exists. |
| Users compare current work against last-working or notable references by reopening files, notebooks, setup notes, and memory. | JNY-006 | Missing UC: compare declared measurement/context facts and selected code context without claiming domain judgment. | CAP-001, CAP-005, CAP-003. | [`product/target-journeys.md`](product/target-journeys.md), selected-reference discovery route. | No live selected-reference owner yet. |
