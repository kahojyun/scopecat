...
| Existing or externally produced runs need low-intrusion recording without replacing the legacy runner. | JNY-007 | UC-001; UC-002. | CAP-001. | [`engineering/workflow-validation-map.md`](engineering/workflow-validation-map.md), [legacy brownfield recording decision](decisions/DEC-004-post-run-first-brownfield-adoption.md) | `scopecat.measurement_records` |
