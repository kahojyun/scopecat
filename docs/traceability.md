...
| Externally produced runs need low-intrusion recording without replacing the legacy runner. | JNY-007 | UC-001; UC-002. | CAP-001. | [`engineering/workflow-validation-map.md`](engineering/workflow-validation-map.md), [`discovery/routes/measurement-records/legacy-brownfield-adoption-decision.md`](discovery/routes/measurement-records/legacy-brownfield-adoption-decision.md) | `scopecat.measurement_records` |
