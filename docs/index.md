...
| [`journeys/jc-001/README.md`](journeys/jc-001/README.md) | Accepted first journey record | Entry point and reading order for `JC-001`, including its accepted passive evidence-view slice. | Earned exemplar, not a folder template for future journey candidates. |
| [`journeys/jc-002/README.md`](journeys/jc-002/README.md) | Drafting journey record | Entry point for the selected-run analysis handoff journey and fixture-backed draft prototype slice. | Drafting only; not an accepted decision, manifest schema, API contract, export format, storage design, or UI spec. |
