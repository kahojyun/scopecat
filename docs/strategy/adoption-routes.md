...
The candidate exploration ladder is local durable record -> export/import
...
validation questions show they are needed.
...
pain-framed routes after user validation or focused reference-case work shows
...
[`../evidence/inventory.md`](../evidence/inventory.md) owns evidence claims, while
[`../evidence/pain-packets/README.md`](../evidence/pain-packets/README.md)
