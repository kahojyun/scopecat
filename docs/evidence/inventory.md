...
| --- | --- | --- | --- | --- | --- |
| JC-001 | 1 | Explain an existing run or work bundle with selected context, code, and artifacts | PN-001, PN-002, PN-005, PN-006; EV-001, EV-002, EV-003, EV-006, EV-013 | Uses stable run/dataset identity as an anchor while making selected configuration, code provenance, dependency readiness, companion artifacts, and ambiguity visible. | Candidate provenance only. Current accepted boundary is owned by [`../journeys/jc-001/README.md`](../journeys/jc-001/README.md). |
| JC-002 | 2 | Selected high-value runs to analysis handoff package | PN-004; EV-009, EV-022, EV-044, EV-045 | Users need to find high-value runs, inspect simple historical previews, mark or multi-select them, and move an immutable pre-analysis data-plus-context snapshot from an experiment-control computer to a personal analysis computer without losing source identity. | Candidate provenance only. Current draft boundary is owned by [`../journeys/jc-002/snapshot-boundary.md`](../journeys/jc-002/snapshot-boundary.md). |
...
| JC-004 | 5 | Clean notebook and copied-code provenance | PN-006; EV-006, EV-008, EV-013, EV-021 | Dense notebook, backup, copied module, checkpoint, and generated-bytecode evidence validates code/notebook evidence capture before managed execution. | Link notebooks, scripts, packages, and generated artifacts as evidence; do not accept automatic notebook-state capture or package-registry scope. |
...
| JC-003 | 7 | Review calibration proposals and impact before mutation | PN-003, PN-014; EV-004, EV-005, EV-015, EV-038 | Clear calibration and parameter mutation evidence supports proposal, impact, review, and shadow-loop concepts before automation. | First slice may validate proposal, impact, review, and shadow-loop evidence; real write-back, rollback, and autonomous calibration require accepted runtime, review, and audit boundaries. |
...
| JC-008 | 10 | Validate a dry-run or mock-queue execution package | PN-018; EV-007, EV-021, EV-023, EV-024, EV-026 | Packages code, context, generated artifacts, environment, expected outputs, queue order, and failure-policy evidence before execution. | Validation record only; no real worker fleet, shell-command product surface, remote execution, resource locking, or device control. |
| JC-011 | 11 | Watch a long-running measurement and produce replayable decision support | TP-010; PN-033, PN-034, PN-035, PN-036, PN-037; EV-046, EV-047 | Consumes explicitly recorded live or replayed measurement records, detects completed analysis slices, shows fit/quality/anomaly feedback, and records stop/continue/retune-style decision evidence. | Advisory or shadow-automation evidence only; no replacement live-plotting product, hardware control, scan-plan mutation, parameter write-back, autonomous calibration, opaque AI advice, passive scraping, framework-specific adapter matrix, or acquisition-path dependency. |
...
| JC-013 | 13 | Diagnose shared code or configuration asset drift from a known-good source | TP-009; PN-005, PN-006, PN-018, PN-020, PN-021, PN-023, PN-024, PN-027, PN-030; EV-006, EV-007, EV-021, EV-032 | Recovers source identity, reusable layers, dependency readiness, drift, validation evidence, diagnostic sharing boundaries, and settings that can serve as seed values. | Diagnostic and reuse evidence only; no Git hosting, package registry, deployment manager, automatic environment sync, code-review platform, authoritative config owner, or full work-bundle import. |
...
| JC-015 | 15 | Ordinary Python script to durable measurement record | PN-009, PN-015, PN-016; EV-012, EV-045 | Closes the substrate gap behind `JC-002` reader realism and `JC-011` recorded-input decision support. | Durable recording substrate only; no managed runner, scheduler, hardware control, device apply, environment mutation, full live viewer, resumable execution promise, or storage/API contract beyond the fixture boundary. |
| JC-016 | 16 | One reviewed package to one lab-owned runtime for one bounded local run | PN-017, PN-018, PN-033; TP-010; EV-024, EV-031, EV-047 | Derived boundary candidate, not independently validated; bridges plan preview, dry-run, proposal review, and advisory evidence into one bounded runtime handoff. | First bounded runtime-handoff boundary only; no Scopecat-owned instrument runtime by default, generic scheduler, workflow DAG, environment sync, package deployment, broad resource-locking system, rollback guarantee, or autonomous calibration platform. |
