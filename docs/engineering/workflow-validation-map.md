...
| --- | --- | --- | --- | --- |
| Calibration continuation review | UC-CAND-005, JNY-003 | Brownfield pain-point and scenario evidence | Review surface, action recording, fit recovery, continuation composition, and parameter-state handoff pressure. | Promote only if a narrow calibration continuation use case has user-step acceptance criteria. |
| Prepared run context and acknowledgement | UC-CAND-002, JNY-002 | Brownfield pain-point and scenario evidence | Context construction, review gate, acknowledgement-aware review, view-state projection, setup-binding pressure, and historical environment-operation pressure. | Promote only around a prepared-run use case with command/result model and acceptance criteria. |
