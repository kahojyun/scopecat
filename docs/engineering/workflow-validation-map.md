...
| JNY-001-SMOKE | Share selected measurement vertical-slice smoke path | JNY-001 | Production vertical slice | CAP-001, CAP-002 | Validate the workflow backbone across use-case segments: selected stored-record export, safe zip archive creation from the DEC-010 package of record, safe zip archive materialization back into the DEC-010 package of record, UC-004 read-only receiving review, import plan, local receiving review-state receipt materialization, and new-record durable import into a second storage root. The smoke summary records stage classifications, final operator result, source-storage-read-only export, transport-only archive bytes, materialized DEC-010 package authority, new-record durable import, and existing-record update non-claim. | GUI-owned persisted receiving state beyond DEC-018 and DEC-023, archive-backed import beyond DEC-021 and DEC-024, batch durable import beyond DEC-017, linked-context payload import beyond DEC-016, existing-record update/import beyond DEC-025, post-run browser/plotter/readiness review beyond JNY-008, and shared domain schema remain unvalidated. | Use this row to decide whether to continue cross-segment production hardening or branch into a named product fork. |
