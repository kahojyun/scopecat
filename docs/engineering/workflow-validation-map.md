...
| UC-CAND-007 | Completed Measurement Record review and finalization | JNY-008 | CAP-001, CAP-005, CAP-002 | Measurement Records review/finalization pressure and selected-record export freshness evidence. | Does completed-record review need a route owner with explicit readiness semantics before handoff, comparison, calibration continuation, or rerun preparation? |
