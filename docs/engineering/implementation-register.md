...
| `scopecat.parameter_state` | Parameter State Review | Adapter-authored review, storage/read view, source-agnostic projection, selection, and route-local manual pre-run review chain. | [`src/scopecat/parameter_state/README.md`](../../src/scopecat/parameter_state/README.md), [`parameter-state.md`](prototype-boundaries/parameter-state.md) |
