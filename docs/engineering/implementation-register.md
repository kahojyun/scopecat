...
| `scopecat.parameter_state` | CAP-003 | Adapter-authored review plus normalized parameter-state storage/write and explicit read view. | [`src/scopecat/parameter_state/README.md`](../../src/scopecat/parameter_state/README.md), [`parameter-state.md`](prototype-boundaries/parameter-state.md) |
