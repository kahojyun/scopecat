...
| [`measurement-records/creation-lifecycle-decision.md`](measurement-records/creation-lifecycle-decision.md) | Decisions and implementation checkpoints for durable measurement-record creation, first writer integration, read view, and receipt-based finalization. |
