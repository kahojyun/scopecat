...
| [`experiment-code/engineering-prototype-promotion-decision.md`](experiment-code/engineering-prototype-promotion-decision.md) | Canonical accepted narrow experiment-code route-local prototype boundary for recording, managed versions, materialization, observation, and rerun preparation. |
| [`calibration-continuation/engineering-prototype-promotion-decision.md`](calibration-continuation/engineering-prototype-promotion-decision.md) | Canonical accepted narrow calibration continuation route-local review-surface and review-action recording boundary. |
| [`measurement-records/creation-lifecycle-decision.md`](measurement-records/creation-lifecycle-decision.md) | Decisions and implementation checkpoints for durable measurement-record creation, writer integration, read view, finalization, read-model projection/refresh/catalog, in-progress inspection, operator review, and saved review receipts. |
...
| [`measurement-context/resolved-context-link-comparison-decision.md`](measurement-context/resolved-context-link-comparison-decision.md) | Canonical accepted narrow resolved measurement-record context-link comparison boundary. |
...
| [`setup-binding/engineering-prototype-promotion-decision.md`](setup-binding/engineering-prototype-promotion-decision.md) | Canonical accepted narrow setup-binding summary and run-start setup-context review boundary. |
| [`selected-reference/engineering-prototype-promotion-decision.md`](selected-reference/engineering-prototype-promotion-decision.md) | Canonical accepted narrow selected-reference context and recorded-code comparison boundary. |
