...
| [`handoff/engineering-prototype-plan.md`](handoff/engineering-prototype-plan.md) | Implemented handoff package reader, inspection, source-root writer, scope, fixture policy, and deferred boundaries. |
| [`handoff/engineering-prototype-readiness.md`](handoff/engineering-prototype-readiness.md) | Readiness judgment and keep/defer boundaries for the read-only handoff package vertical. |
| [`handoff/engineering-prototype-promotion-decision.md`](handoff/engineering-prototype-promotion-decision.md) | Promotion decision for the accepted read-only handoff baseline and source-root writer extension. |
