...
| [`measurement-records/creation-lifecycle-decision.md`](measurement-records/creation-lifecycle-decision.md) | Decision and implementation checkpoints for durable measurement-record creation, first writer integration, and read view. |
