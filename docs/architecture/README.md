...
| [`measurement-records/creation-lifecycle-decision.md`](measurement-records/creation-lifecycle-decision.md) | Decision and implementation checkpoint for the first durable measurement-record creation lifecycle boundary. |
