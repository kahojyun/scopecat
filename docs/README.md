...
Scopecat is in a fast redesign phase around the experiment core. When a cleaner
model wins, update the code, tests, fixtures, and docs in the same pass instead
of preserving compatibility layers for abandoned internal shapes.

## Document Set

- [Project charter](project-charter.md): long-term product direction,
  non-goals, and design principles.
- [Experiment core](experiment-core.md): active design notes for the structured
  experiment stack, configuration input, planning model, runtime boundary, and
  data capture shape.
...
- the current experiment-core model being built;
