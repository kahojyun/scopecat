...
| `jc-001/README.md` | Active first-wedge record | Entry point, audience read paths, accepted boundary, fixture-validated prototype, manifest/public-output contract, and reusable promotion pattern for the first accepted `JC-001` wedge. | Earned exemplar, not a folder template for future journey candidates. |
