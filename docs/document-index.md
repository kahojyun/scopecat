...
| `progressive-adoption-progress-tracker.md` | Active tracker | Tracking journey-first discovery, adoption ladders, migration wedges, contracts, and decision promotion. | `JC-001` is ready for W4 migration-wedge shaping, but W4+ wedges, contracts, and subsystem ideas remain hypotheses until promoted by the journey and capability extraction. |
