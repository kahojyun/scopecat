...
| `progressive-adoption-progress-tracker.md` | Active tracker | Tracking journey-first discovery, adoption ladders, migration wedges, contracts, and decision promotion. | `JC-001` is ready for concept/contract extraction, but contracts, technical spikes, and subsystem ideas remain hypotheses until promoted by the wedge. |
