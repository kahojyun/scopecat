...
| `jc-001-passive-evidence-view-prototype-scope.md` | Initial implementation spike in place | Implementation-facing scope for the accepted passive evidence-view prototype, now recording the project-owned prototype script, public-safe fixture, tests, validation command, acceptance checks, non-goals, risks, and selected fixture strategy. | This is not implementation architecture. The first prototype remains read-only and fixture-sized; the selected fixture strategy is test-owned and does not accept broader fixture import or sample-data policy. |
