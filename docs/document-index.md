...
| `jc-002/README.md` | Drafting journey record | Entry point for the selected-run analysis handoff document set, including journey selection, snapshot definition, current/future journey seed, and draft prototype scope. | Drafting only; not an accepted decision, fixture-validated prototype, manifest schema, API contract, export format, storage design, or UI spec. |
