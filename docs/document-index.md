...
| `vision.md` | Drafting project vision | Current project-level direction and boundaries: progressive adoption, explicit recording, complementing existing experiment systems, complexity ownership, and clear non-goals. | Not a roadmap, PRD, capability map, API/schema/UI/storage contract, or architecture decision. |
...
| `product-experience-map.md` | Drafting experience map | Complete-experience shape across journey candidates, experience-step labels, and journey coverage gaps. | Not a `JC` owner, accepted product plan, roadmap, capability map, API/schema/UI/storage contract, or prototype scope. |
...
| `research/extracted/experimental-lab-workflow-reference.md` | Quarantined research input | Public-safe lab workflow reference for gap discovery and artifact-intent extraction. | Use as research context only; do not promote directly into product scope. |
