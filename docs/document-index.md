...
| `analysis-handoff-candidate-note.md` | Candidate owner note | Current owner for the starred-run analysis-handoff candidate, including adoption pressure, validation coverage, live-preview boundary, and deferred design details. | Not an accepted journey, implementation plan, API contract, export format, storage design, UI spec, or new `JC-###` folder. |
