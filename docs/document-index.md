...
| `jc-002/README.md` | Drafting journey record | Entry point for the selected-run analysis handoff document set, including journey selection, snapshot definition, context tiers, and current/future journey seed. | Drafting only; not an accepted decision, implementation plan, manifest schema, API contract, export format, storage design, or UI spec. |
