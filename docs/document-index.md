...
| `jc-001/README.md` | Active first-wedge record | Entry point, audience read paths, accepted boundary, fixture-validated prototype, manifest/public-output contract, and first-wedge history for `JC-001`. | Index/history status only; contained artifacts have mixed validation statuses. Earned exemplar, not a process owner or folder template for future journey candidates. |
