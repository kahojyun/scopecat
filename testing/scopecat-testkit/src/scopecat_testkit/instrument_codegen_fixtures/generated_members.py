...
SHARED_ACQUISITION_RESULT = InterfaceRef("test.generated_shared_acquisition_result/v1")
SHARED_ACQUISITION_RESULT_SAMPLE_LEFT = SHARED_ACQUISITION_RESULT.acquisition(
    "sample_left",
)
SHARED_ACQUISITION_RESULT_SAMPLE_LEFT_VALUE_RESULT = (
    SHARED_ACQUISITION_RESULT_SAMPLE_LEFT.result(
        "value",
    )
)
SHARED_ACQUISITION_RESULT_SAMPLE_RIGHT = SHARED_ACQUISITION_RESULT.acquisition(
    "sample_right",
)
SHARED_ACQUISITION_RESULT_SAMPLE_RIGHT_VALUE_RESULT = (
    SHARED_ACQUISITION_RESULT_SAMPLE_RIGHT.result(
        "value",
    )
)
...
__all__ = [
    ...
    "SHARED_ACQUISITION_RESULT",
    "SHARED_ACQUISITION_RESULT_SAMPLE_LEFT",
    "SHARED_ACQUISITION_RESULT_SAMPLE_LEFT_VALUE_RESULT",
    "SHARED_ACQUISITION_RESULT_SAMPLE_RIGHT",
    "SHARED_ACQUISITION_RESULT_SAMPLE_RIGHT_VALUE_RESULT",
