...
def test_workflow_analysis_review_activate_and_rerun_active_config(
    ...
    assert summary_input.codec == "scopecat.measurement-dataset.v11"
...
def test_analysis_trace_records_its_analysis_dependency(tmp_path: Path) -> None:
    ...
    assert dependency.codec == "scopecat.measurement-dataset.v11"
    ...
    assert input_binding.codec == "scopecat.measurement-dataset.v11"
