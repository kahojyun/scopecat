...
backend, materialize points, or produce a target artifact. Those are explicit
decisions of a later lowering, allowing the same successful linked plan to feed
local or domain-specific targets.
"""
