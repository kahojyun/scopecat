...
from scopecat.models.config import ConfigProfileSnapshot, RoutingGraph, RoutingResource
from scopecat.problems import ModelLocation, ProblemPhase, model_location
from scopecat.value_types import Float, Scalar, String, Table, TableColumn
from tests.support.authoring import load_config
from tests.support.relation_plans import point_domain, scalar_value_expr
...
def test_direct_physical_record_is_not_captured_by_same_named_logical_port() -> None:
    ...
    plan = bind_program(program, validate_config_environment(config))
...
def test_unused_logical_product_producer_does_not_constrain_route_placement() -> None:
    ...
    plan = bind_program(linked.program, linked.environment)
