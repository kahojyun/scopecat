...
from scopecat.authoring._resolution import _apply_scans
from scopecat.authoring._scan_dependencies import (
    ScanDependencyError,
...
from scopecat.authoring._scan_lowering import lower_scan_points
...
from scopecat.value_types import Table
