...
from scopecat.results import CoordinateValue
from tests.test_measurement_value_assembly import _Scenario, _scenario
...
def _assembly(scenario: _Scenario) -> SelectedMeasurementValueAssembly:
...
def _program(scenario: _Scenario, *, collected_use: ProductUse) -> ExecutionProgram:
...
) -> tuple[_Scenario, ExecutionProgram, BoundLocalCollectionFragment]:
