...
from scopecat._relations import RelationExpr, grid, point_col, table
...
from scopecat.value_types import Scalar, String, ValueType
...
def test_preview_reports_missing_point_parameters_before_evaluation() -> None:
    spec = typed_program(
        id="missing-points",
        kind="problem",
    ...
    assert [problem.code for problem in problems] == ["linked_parameter_missing"]
