...
from scopecat.kernel.problems import ModelLocation, ProblemCategory, ProblemPhase
...
def test_target_backend_rejection_precedes_point_materialization() -> None:
    ...
    plan = materialize_local_plan(
        link_program(load_experiment(), environment), relation_backend=target_backend
    )
