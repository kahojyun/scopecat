...
_TEMPERATURE_READOUT_SPEC_JSON = (
    ...
    'rature.","role":"observable","dtype":"fl'
    'oat64","unit":"K","axes":[]},{"id":"resi'
    'stance","label":"Resistance","descriptio'
    'n":"Current scan-channel sensor resistan'
    'ce.","role":"observable","dtype":"float6'
...
_DC_SOURCE_SPEC_JSON = (
    ...
    'm":null,"finite":true}}],"invalidates":['
    ']},{"id":"source_current","label":"Sourc'
    'e current","description":"Select current'
    "-source mode and set its range and level"
    '.","arguments":[{"id":"range","label":nu'
    'll,"description":null,"value_type":{"typ'
    'e":"quantity","dimension":null,"unit":"A'
    '","minimum":null,"maximum":null,"finite"'
    ':true}},{"id":"level","label":null,"desc'
    'ription":null,"value_type":{"type":"quan'
    'tity","dimension":null,"unit":"A","minim'
    'um":null,"maximum":null,"finite":true}}]'
    ',"invalidates":[]}],"acquisitions":[],"c'
    'omponents":[]}'
)
...
_DC_MONITOR_SPEC_JSON = (
    ...
    'hile sourcing voltage.","role":"observab'
    'le","dtype":"float64","unit":"A","axes":'
    '[]}]},{"id":"measure_voltage","label":"M'
    'easure voltage","description":"Measure v'
    "oltage while the source is operating in "
    'current mode.","preconditions":[],"resul'
    'ts":[{"id":"monitored_voltage","label":"'
    'Monitored voltage","description":"One me'
    'asurement while sourcing current.","role'
    '":"observable","dtype":"float64","unit":'
    '"V","axes":[]}]}],"components":[]}'
)
...
_NETWORK_SWEEP_SPEC_JSON = (
    ...
    'for the acquired trace.","role":"coordin'
    'ate","dtype":"float64","unit":"Hz","axes'
    '":[{"id":"frequency","label":"Frequency"'
    ...
    '},"unit":"Hz"}]},{"id":"s_parameter","la'
    'bel":"Complex S-parameter","description"'
    ':"Complex response values for the config'
    'ured S-parameter.","role":"observable","'
