...
TEMPERATURE_READOUT_TEMPERATURE = TEMPERATURE_READOUT.property("temperature")
TEMPERATURE_READOUT_RESISTANCE = TEMPERATURE_READOUT.property("resistance")
TEMPERATURE_READOUT_READING_STATUS = TEMPERATURE_READOUT.property("reading_status")
TEMPERATURE_READOUT_HEATER_OUTPUT = TEMPERATURE_READOUT.property("heater_output")
TEMPERATURE_READOUT_HEATER_RANGE = TEMPERATURE_READOUT.property("heater_range")
TEMPERATURE_READOUT_HEATER_STATUS = TEMPERATURE_READOUT.property("heater_status")
