...
_PUBLIC_EXPORT_MODULES: dict[str, str] = {
    ...
    "DCSourceCurrentTarget": "scopecat_instruments.states",
    ...
    "DCSourceVoltageGroupTarget": "scopecat_instruments.states",
    "DCSourceVoltagePatch": "scopecat_instruments.states",
    "DCSourceVoltageTarget": "scopecat_instruments.states",
